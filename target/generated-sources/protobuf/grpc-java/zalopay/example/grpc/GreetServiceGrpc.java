...
public final class GreetServiceGrpc {
  ...
  public static final String SERVICE_NAME = "zalopay.example.grpc.GreetService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<zalopay.example.grpc.registerRequest,
      zalopay.example.grpc.registerResponse> METHOD_REGISTER_GREET =
      io.grpc.MethodDescriptor.<zalopay.example.grpc.registerRequest, zalopay.example.grpc.registerResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "zalopay.example.grpc.GreetService", "registerGreet"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              zalopay.example.grpc.registerRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              zalopay.example.grpc.registerResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class GreetServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void registerGreet(zalopay.example.grpc.registerRequest request,
        io.grpc.stub.StreamObserver<zalopay.example.grpc.registerResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                zalopay.example.grpc.registerRequest,
                zalopay.example.grpc.registerResponse>(
  ...
  public static final class GreetServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetServiceBlockingStub> {
    ...
    /**
     */
    public zalopay.example.grpc.registerResponse registerGreet(zalopay.example.grpc.registerRequest request) {
  ...
  public static final class GreetServiceFutureStub extends io.grpc.stub.AbstractStub<GreetServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<zalopay.example.grpc.registerResponse> registerGreet(
        zalopay.example.grpc.registerRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER_GREET:
          serviceImpl.registerGreet((zalopay.example.grpc.registerRequest) request,
              (io.grpc.stub.StreamObserver<zalopay.example.grpc.registerResponse>) responseObserver);
          break;
        default:
  ...
  private static final class GreetServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return zalopay.example.grpc.Greet.getDescriptor();
    }
  }
